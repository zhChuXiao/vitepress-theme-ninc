...
<style scoped>
/* 
  原始组件使用 Tailwind 工具类（relative / inline-block / absolute / 
  pointer-events-none / z-20），但本项目未启用 Tailwind，这些类名不会产生 
  实际 CSS。这里用真实 CSS 把它们补出来，否则 SVG 星星会因缺少 
  position: absolute 而退回普通流，全部竖向堆在左侧。
*/
