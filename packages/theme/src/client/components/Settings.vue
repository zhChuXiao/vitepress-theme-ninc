      ...
      <div class="set-list">
        ...
        <div class="set-item">
          ...
          <div class="set-options">
            <span :class="['options', { choose: fontFamily === 'hmos' }]" @click="fontFamily = 'hmos'"> HarmonyOS Sans </span>
            <span :class="['options', { choose: fontFamily === 'JinBuTi' }]" @click="fontFamily = 'JinBuTi'"> 进步体 </span>
          </div>
        </div>
        <div class="set-item">
        ...
        <div class="set-item">
          ...
          <div class="set-options">
            <span :class="['options', { choose: backgroundType === 'close' }]" @click="backgroundType = 'close'"> 关闭 </span>
        ...
        <span class="title home-title">首页样式</span>
        <div class="set-item home-item">
          <span class="set-label">Banner 高度</span>
          <div class="set-options">
            <span :class="['options', { choose: bannerType === 'half' }]" @click="bannerType = 'half'"> 半屏 </span>
            <span :class="['options', { choose: bannerType === 'full' }]" @click="bannerType = 'full'"> 全屏 </span>
          </div>
        </div>
        ...
        <div class="set-item">
          ...
          <div class="set-options">
            <span :class="['options', { choose: infoPosition === 'normal' }]" @click="infoPosition = 'normal'"> 默认位置 </span>
            <span :class="['options', { choose: infoPosition === 'fixed' }]" @click="infoPosition = 'fixed'"> 右下角 </span>
          </div>
        </div>
      </div>
    </Modal>
